            ...
            <div className="max-w-6xl mx-auto  rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-16 relative overflow-hidden shadow-2xl border border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
                    ...
                    <div className="order-2 md:order-1 text-center md:text-left space-y-8">
                        <h2 className="text-5xl md:text-7xl font-bold text-black tracking-tighter leading-tight">
                            Start Studying
                            <span className="block bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Smarter Today</span>
                        </h2>
                        <p className="text-lg md:text-xl text-slate-400 font-light max-w-lg mx-auto md:mx-0">
                            Transform your study routine with AI-powered tools designed for modern students.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                            <button className="relative group px-10 py-5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold rounded-full text-lg overflow-hidden transition-all hover:scale-105 shadow-[0_0_20px_rgba(99,102,241,0.4)]">
                                <span className="relative z-10">Join CampusKey Free</span>
                                {/* Shine effect */}
                                <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent to-white/20 opacity-40 group-hover:animate-shine left-[-100%]" />
                            </button>
                            <button className="px-8 py-5 bg-white/5 backdrop-blur-sm text-white font-semibold rounded-full text-lg border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                                Watch Demo
                            </button>
                        </div>
                    </div>

                    {/* SVG Illustration Container - Order 1 on mobile, 2 on desktop */}
                    <div className="order-1 md:order-2 flex justify-center md:justify-end animate-custom-float">
                        <svg className="w-auto max-w-[16rem] md:max-w-md h-auto text-gray-800 dark:text-white" aria-hidden="true" width="627" height="499" viewBox="0 0 627 499" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M429 6C429 2.68629 431.686 0 435 0H610C613.314 0 616 2.68629 616 6V163C616 166.314 613.314 169 610 169H435C431.686 169 429 166.314 429 163V6Z" fill="#1F2A37" />
                            <path d="M429 6C429 2.68629 431.686 0 435 0H610C613.314 0 616 2.68629 616 6V163C616 166.314 613.314 169 610 169H435C431.686 169 429 166.314 429 163V6Z" fill="url(#paint1_linear_182_7959)" />
                            <path d="M0 184C0 180.686 2.68629 178 6 178H206C209.314 178 212 180.686 212 184V361C212 364.314 209.314 367 206 367H6C2.68629 367 0 364.314 0 361V184Z" fill="#1F2A37" />
                            <path d="M0 184C0 180.686 2.68629 178 6 178H206C209.314 178 212 180.686 212 184V361C212 364.314 209.314 367 206 367H6C2.68629 367 0 364.314 0 361V184Z" fill="url(#paint2_linear_182_7959)" />
                            <path d="M178 79C178 75.6863 180.686 73 184 73H464C467.314 73 470 75.6863 470 79V279C470 282.314 467.314 285 464 285H184C180.686 285 178 282.314 178 279V79Z" fill="#374151" />
                            <path d="M178 79C178 75.6863 180.686 73 184 73H464C467.314 73 470 75.6863 470 79V279C470 282.314 467.314 285 464 285H184C180.686 285 178 282.314 178 279V79Z" fill="url(#paint3_linear_182_7959)" fillOpacity="0.7" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M464 75H184C181.791 75 180 76.7909 180 79V279C180 281.209 181.791 283 184 283H464C466.209 283 468 281.209 468 279V79C468 76.7909 466.209 75 464 75ZM184 73C180.686 73 178 75.6863 178 79V279C178 282.314 180.686 285 184 285H464C467.314 285 470 282.314 470 279V79C470 75.6863 467.314 73 464 73H184Z" fill="#374151" />
                            ...
                            <path fillRule="evenodd" clipRule="evenodd" d="M505 452V465.5C505 471.299 509.701 476 515.5 476C521.299 476 526 471.299 526 465.5V452H505ZM504.647 450C503.737 450 503 450.737 503 451.647V465.5C503 472.404 508.596 478 515.5 478C522.404 478 528 472.404 528 465.5V451.647C528 450.737 527.263 450 526.353 450H504.647Z" fill="#c8d8fa" fillOpacity="0.4" />
                            <path fillRule="evenodd" clipRule="evenodd" d="
/>
                            <path fillRule="evenodd" clipRule="evenodd" d="M476.752 46.3458C477.028 46.3605 477.239 46.5959 477.225 46.8717L476.86 53.7411C476.853 53.8638 476.961 53.9613 477.083 53.9422L479.994 53.4849C480.267 53.442 480.523 53.6284 480.565 53.9012C480.608 54.174 480.422 54.4299 480.149 54.4727L477.238 54.9301C476.488 55.0479 475.821 54.4456 475.861 53.688L476.226 46.8186C476.241 46.5428 476.476 46.3312 476.752 46.3458Z" fill="#111928" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M484.467 57.748C485.209 57.4411 485.733 56.7748 485.939 55.8873C486.001 55.6182 486.27 55.4507 486.539 55.5131C486.808 55.5754 486.975 55.8441 486.913 56.1131C486.646 57.262 485.937 58.222 484.85 58.6719C483.765 59.1212 482.398 59.0238 480.884 58.2573C480.638 58.1325 480.539 57.8317 480.664 57.5853C480.789 57.339 481.09 57.2404 481.336 57.3651C482.669 58.0402 483.724 58.0556 484.467 57.748Z" fill="#111928" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M498.124 40.1608C498.049 39.4296 497.686 38.863 497.2 38.34C497.012 38.1377 497.023 37.8213 497.226 37.6333C497.428 37.4453 497.744 37.4569 497.932 37.6592C498.494 38.2633 499.012 39.0249 499.119 40.0588C499.224 41.0872 498.913 42.2984 498.003 43.791C497.859 44.0268 497.551 44.1014 497.316 43.9576C497.08 43.8138 497.005 43.5062 497.149 43.2704C497.992 41.8883 498.199 40.8975 498.124 40.1608Z" fill="#111928" />
                            ...
                            <path d="M61.5 278.5C60.7 271.3 56.1667 259.167 54 254L69 255.5L76 274.5C72 278.9 64.6667 279 61.5 278.5Z" fill="url(#paint20_linear_182_7959)" />
                            ...
                            <path fillRule="evenodd" clipRule="evenodd" d="M78.9752 246.307L71.2676 249.384C73.3886 251.761 76.251 252.801 80.0391 250.846C79.8999 249.402 79.5246 247.873 78.9752 246.307Z" fill="white" />
                            ...
                            <defs>
                                ...
                                <linearGradient id="paint1_linear_182_7959" x1="522.5" y1="-35.7672" x2="522.5" y2="135.468" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#374151" />
                                    <stop offset="1" stopColor="#374151" stopOpacity="0" />
                                </linearGradient>
                                ...
                                <linearGradient id="paint14_linear_182_7959" x1="472" y1="43.5" x2="510.595" y2="50.0492" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#7F270F" />
                                    <stop offset="1" stopColor="#7F270F" stopOpacity="0" />
                                </linearGradient>
                                <linearGradient id="paint15_linear_182_7959" x1="18.9306" y1="450.508" x2="62.5185" y2="182.125" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#7F270F" />
                                    <stop offset="1" stopColor="#7F270F" stopOpacity="0" />
                                </linearGradient>
                                ...
                                <linearGradient id="paint17_linear_182_7959" x1="73" y1="451.5" x2="40.8831" y2="299.172" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#7F270F" />
                                    <stop offset="1" stopColor="#7F270F" stopOpacity="0" />
                                </linearGradient>
                                ...
                                <linearGradient id="paint20_linear_182_7959" x1="93.0323" y1="255.475" x2="62.4765" y2="272.439" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#7F270F" />
                                    <stop offset="1" stopColor="#7F270F" stopOpacity="0" />
                                </linearGradient>
                            </defs>
